...
import { Award, Mail, ArrowDown, Sparkles, Star, TrendingUp, Building2, Globe, ShieldCheck } from 'lucide-react';
    ...
    <header className="relative space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <motion.div
          ...
          className="lg:col-span-4 bg-gradient-to-br from-sky-950/90 via-slate-900 to-slate-900 border border-sky-500/30 rounded-2xl p-6 sm:p-7 flex flex-col justify-between shadow-xl shadow-slate-950/40 relative overflow-hidden"
        >
          ...
          <div className="mt-6 pt-4 border-t border-sky-500/20 flex items-center justify-between text-xs text-sky-300/80">
            <span className="font-mono uppercase">Global Edition</span>
            <span className="font-semibold text-slate-200">XNORB Technology</span>
          </div>
        </motion.div>
      </div>
